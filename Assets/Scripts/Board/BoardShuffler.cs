...
namespace KKoding92.Board
{
    ...
    public class BoardShuffler
    {
        ...
        /*
         * 씬이 시작되고 보드 구성시에 호출되면 true, 플레이 도중에 호출되면 false를 갖는다.
         * 플레이 도중에 호출되는 경우는 더이상 이동할 수 있는 블럭이 없는 경우에 보드를 섞거나, 
         * 셔플 아이템을 사용해서 강제로 보드를 섞는 경우에 사용될 것이다.
         */
        bool m_bLoadingMode;
        ...
        /*
         * 블럭 매칭 정보 업데이트하기 
         * 보드를 구성하는 모든 블럭의 연속배치 정보를 계산한다. 
         * 셔플 미대상인 블럭(현재 상태에서 움직이지 못하는 블럭)의 주변을 조사해서 연속배치 정보를 각 블럭에 기록하는 것이 주 목적이다
         */
